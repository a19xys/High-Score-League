...
La deduplicacion combina userId, connectivityGeneration, queueRevision y
sessionRevision. Estados temporales no consumen una oportunidad terminal. Los
locks global, por cuenta, por scope y de `submitAll` evitan cruces y duplicados.
