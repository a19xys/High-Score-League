...
const BUSY_CONTENT_BY_LABEL = Object.freeze({
  "Comprobando conexi\u00f3n": {
    ...
    hint: "Verificando la conexión con High Score League.",
    variant: "working",
  },
  ...
  "Preparando pack": {
    title: "Preparando pack...",
    hint: "Comprobando la sesión y la disponibilidad del pack.",
    variant: "working",
  },

  "Descargando pack": {
    title: "Descargando pack...",
    hint: "Guardando el pack de forma segura.",
    variant: "working",
  },

  "Verificando pack": {
    title: "Verificando pack...",
    hint: "Comprobando el tamaño y la integridad de la descarga.",
    variant: "working",
  },
